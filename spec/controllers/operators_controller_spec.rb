  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved operator as @operator" do
        ...
        post :create, {:operator => { "name" => "invalid value" }}, valid_session
        assigns(:operator).should be_a_new(Operator)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested operator" do
        ...
        Operator.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => operator.to_param, :operator => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the operator as @operator" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Operator.any_instance.stub(:save).and_return(false)
        put :update, {:id => operator.to_param, :operator => { "name" => "invalid value" }}, valid_session
        assigns(:operator).should eq(operator)
      end
